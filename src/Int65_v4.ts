// This new type is basically a clone of the Int64 type
// The idea is to represent Float64 numbers as Int64 numbers with a scale factor
// So in order to represent 1.5, we would use 1.5 * 10^4 = 15000
// This is a hack to get around the fact that we can't use floats in the snark
// The scale factor is 10^4
// at the moment there is no scaling
